...
def test_delete_random_address_from_random_group(app, db):
    ...
    app.address.delete_address_from_group(address.id, group.id)
    new_addresses_in_group = orm.get_addresses_in_group(group)
